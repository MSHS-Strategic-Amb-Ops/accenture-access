...
payer_mix_dep2 <- payer_mix_dep %>%
  mutate(location = ifelse(str_detect(DEPARTMENT_NAME, "5 E 98"), "5 E 98TH",
                           ifelse(str_detect(DEPARTMENT_NAME, "325 W 15TH"), "Chelsea", "")))
...
referrals_mshs_baseline <- caboodle_referrals_conn %>%
  ...
  summarise(non_converted = n_distinct(ReferralEpicId[AppointmentStatus %in% c("*Unknown", "*Unspecified")]),
            scheduled = n_distinct(ReferralEpicId[AppointmentStatus %in% c("Arrived", "Completed", "Left without seen", "No Show", "Scheduled")]),
...
# require(openxlsx)
# write.xlsx(department_merged, "department_merged_073025.xlsx")
