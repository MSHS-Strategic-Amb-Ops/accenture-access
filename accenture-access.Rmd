...
no_show_mshs_baseline_physician <- access_raw_tbl %>%
  ...
  rename("Arrived_Physician" = Arrived,
         ...
         "SameDay_Canceled_Physician" = SameDay_Canceled,
         "perc_noShowPlus_Physician" = perc_noShowPlus,
         "perc_noShow_Physician" = perc_noShow,
         "perc_SameDayCanceled_Physician" = perc_SameDayCanceled,
         "Year" = appt_year,
         "Month" = appt_month)
...
# ref_baseline <- caboodle_referrals_conn %>%
#   head(10) %>%
#   collect()
# 
# 
# ref_fact <- caboodle_referralFact_conn %>%
#   head(10) %>%
#   collect()
# 
# 
# ref_dept <- caboodle_referrals_conn %>%
#   left_join(caboodle_referralFact_conn %>% dplyr::select(ReferralEpicId, FirstReasonForReferral)) %>%
...
#   # group_by(ReceivedBySite, ReceivedBySpecialtyFromDepDim, ReceivedByDept, ReceivedByDepID, start_year, start_month, ProcedureName, InAnyWorkqueue) %>%
...
mshs_roi <- mshs_roi %>%
  mutate(Arrived_Physician_var_baseline = (Arrived_Physician - Arrived_Physician_prior_year)/Arrived_Physician_prior_year,
         ...
         perc_noShowPlus_Physician_actualized= ifelse(perc_noShowPlus_Physician_var_baseline >0, 0, 
                                                      perc_noShowPlus_Physician_var_baseline*(Arrived_Physician + No_Show_Physician + SameDay_Canceled_Physician)*(-1)),
...
col_order <- c("Month", "Year",
               ...
               "No_Show_Physician", "SameDay_Canceled_Physician",
  ...
  columnGroups = list(
    ...
    colGroup(name = paste0("C.1.1 No Show & Same-Day Cancel Reduction*"),
             columns = c("perc_noShowPlus_Physician_prior_year", "perc_noShowPlus_Physician",
                         "perc_noShowPlus_Physician_var_baseline", "No_Show_Physician", "SameDay_Canceled_Physician",
                         "perc_noShowPlus_Physician_actualized", "perc_noShowPlus_Physician_actualized_dollar",
  ...
  columns = list(
    ...
    perc_noShowPlus_Physician_prior_year = colDef(
      ...
      aggregate = JS("function(values, rows) {
        ...
        let totalSameDay_Canceled_Physician_prior_year = 0
        rows.forEach(function(row) {
          totalArrived_Physician_prior_year += row['Arrived_Physician_prior_year']
          totalNo_Show_Physician_prior_year += row['No_Show_Physician_prior_year']
          totalSameDay_Canceled_Physician_prior_year += row['SameDay_Canceled_Physician_prior_year']
        })
        return (totalNo_Show_Physician_prior_year + totalSameDay_Canceled_Physician_prior_year) / (totalArrived_Physician_prior_year + totalNo_Show_Physician_prior_year + totalSameDay_Canceled_Physician_prior_year) || '-'
      }"),
      format = colFormat(percent = TRUE, digits = 1)),
    ...
    perc_noShowPlus_Physician = colDef(
      ...
      aggregate = JS("function(values, rows) {
        ...
        let totalSameDay_Canceled_Physician = 0
        rows.forEach(function(row) {
          totalArrived_Physician += row['Arrived_Physician']
          totalNo_Show_Physician += row['No_Show_Physician']
          totalSameDay_Canceled_Physician += row['SameDay_Canceled_Physician']
        })
        return (totalNo_Show_Physician + totalSameDay_Canceled_Physician) / (totalArrived_Physician + totalNo_Show_Physician + totalSameDay_Canceled_Physician) || '-'
      }"),
      format = colFormat(percent = TRUE, digits = 1)),
    ...
    perc_noShowPlus_Physician_var_baseline = colDef(
      ...
      aggregate = JS("function(values, rows) {
        ...
        return ((totalNo_Show_Physician + totalSameDay_Canceled_Physician) / (totalArrived_Physician + totalNo_Show_Physician + totalSameDay_Canceled_Physician)) - ((totalNo_Show_Physician_prior_year + totalSameDay_Canceled_Physician_prior_year) / (totalArrived_Physician_prior_year + totalNo_Show_Physician_prior_year + totalSameDay_Canceled_Physician_prior_year)) || '-'
      }"),
      style = JS("function(rowInfo) {
    ...
    SameDay_Canceled_Physician = colDef(
      name = "2025 Same-Day Canceled",
      aggregate = "sum",
      maxWidth = 100,
      headerStyle = list(background = "#d80b8c", color = "white", fontWeight = "Bold", fontSize = "14px"),
      format = colFormat(separators = TRUE, digits = 0)),
    ...
    perc_noShowPlus_Physician_actualized = colDef(
      ...
      #     totalSameDay_Canceled_Physician += row['SameDay_Canceled_Physician']
      #   })
      #   return Math.max(0,((((totalNo_Show_Physician_prior_year + totalSameDay_Canceled_Physician_prior_year) / (totalArrived_Physician_prior_year + totalNo_Show_Physician_prior_year + totalSameDay_Canceled_Physician_prior_year)) - ((totalNo_Show_Physician + totalSameDay_Canceled_Physician) / (totalArrived_Physician + totalNo_Show_Physician + totalSameDay_Canceled_Physician))) * (totalArrived_Physician + totalNo_Show_Physician + totalSameDay_Canceled_Physician))) || '-'
      # }"),
    ...
    perc_noShowPlus_Physician_actualized_dollar = colDef(
      ...
      #     totalSameDay_Canceled_Physician += row['SameDay_Canceled_Physician']
      #   })
      #   return Math.max(0,((((totalNo_Show_Physician_prior_year + totalSameDay_Canceled_Physician_prior_year) / (totalArrived_Physician_prior_year + totalNo_Show_Physician_prior_year + totalSameDay_Canceled_Physician_prior_year)) - ((totalNo_Show_Physician + totalSameDay_Canceled_Physician) / (totalArrived_Physician + totalNo_Show_Physician + totalSameDay_Canceled_Physician))) * (totalArrived_Physician + totalNo_Show_Physician + totalSameDay_Canceled_Physician))*110) || '-'
      # }"),
      style = list(fontWeight = "Bold", background = "#fcdcf0"),
    ...
    perc_noShowPlus_Physician_var_target = colDef(
      ...
      aggregate = JS("function(values, rows) {
        ...
        return ((totalNo_Show_Physician + totalSameDay_Canceled_Physician) / (totalArrived_Physician + totalNo_Show_Physician + totalSameDay_Canceled_Physician))-.12 || '-'
      }"),
    style = JS("function(rowInfo) {
    ...
    SameDay_Canceled_Physician_prior_year = colDef(show =F),
...
<p style="font-size:10pt; font-style:italic">***Estimated Revenue Impact is calculated based on (2025 - 2024 No Show Plus Rate) X (Arrived + No Show + Same-Day Canceled) X ($110 per Visit); sum of monthly estimated revenue impact, not YTD calculated.<p/><br/>
<br/>
...
perc_noShow = colDef(
    ...
    SameDay_Canceled_Physician = colDef(show =F),
