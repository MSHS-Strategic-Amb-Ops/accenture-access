...
#   collect() %>%
#   utate(PAT_ENC_CSN_ID = as.numeric(PAT_ENC_CSN_ID), HSP_ACCOUNT_ID = as.numeric(HSP_ACCOUNT_ID))
# 
# fpax_tbl <- tbl(conn1, "HSP_TRANSACTIONS")
# 
# 
...
#   group_by(SITE, DEPT_SPECIALTY_NAME, DEPARTMENT_NAME, FINANCIAL_DIVISION_ID, FINANCIAL_DIVISION, PROV_NAME_WID, PAT_ENC_CSN_ID, HSP_ACCOUNT_ID) %>%
#   summarise(total = n()) %>%
#   collect()
# 
# 
...
#   left_join(hb_trans %>% mutate(PAT_ENC_CSN_ID = as.numeric(PAT_ENC_CSN_ID), HSP_ACCOUNT_ID = as.numeric(HSP_ACCOUNT_ID)))
...
col_order <- c("Month", "Year",
               ...
               "perc_conversion_prior_year", "perc_conversion", "perc_conversion_mshs_target", "perc_conversion_var_target")
