...
#   head(1000) %>%
#   collect()
#   group_by(SITE, DEPT_SPECIALTY_NAME, DEPARTMENT_NAME, FINANCIAL_DIVISION_ID, FINANCIAL_DIVISION, PROV_NAME_WID) %>%
#   summarise(total = n())
...
<p style="font-size:10pt; font-style:italic">**Estimated Revenue Impact is calculated based on (2025 - 2024 No Show Plus Rate) X (Arrived + No Show + Same-Day Canceled) X ($110 per Visit).<p/><br/>
<br/>
