...
#   left_join(caboodle_referralFact_conn %>% dplyr::select(ReferralEpicId, InAnyWorkqueue)) %>%
...
```
<br/>
<p style="font-size:9pt; font-style:italic">*Volume, Provider Utilization, and No Show metrics shown on this page are based on physician visits only (PROV_TYPE = "Physician").<p/><br/>
<p style="font-size:9pt; font-style:italic">**Estimated Revenue Impact is calculated based on (2025 - 2024 No Show Plus Rate) X (Arrived + No Show + Same-Day Canceled) X ($110 per Visit).<p/><br/>
<br/>
